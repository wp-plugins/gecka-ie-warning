=== Plugin Name ===
Contributors: Gecka
Donate link: http://gecka-apps.com/
...
(based on [ie6-upgrade-warning](http://code.google.com/p/ie6-upgrade-warning/))
...
1. Setup the plugin from the Settings > Reading admin page
