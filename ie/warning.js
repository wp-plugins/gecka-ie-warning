...
function iew(str) {
	...
	if (iews.cookie != '0' && iewrc('iew_dontShowAgain'))
		return false;
	...
	_h.appendChild(document.createTextNode(iews.msg1));
	...
	_p1.appendChild(document.createTextNode(iews.msg2));

	var _p1d = document.getElementById('_p1');
	_p1d.style.marginBottom = "1em";
	_p2.appendChild(document.createTextNode(iews.msg3));

	var _p2d = document.getElementById('_p2');
	_p2d.style.marginBottom = "1em";
	_p3.innerHTML = '<a href="#" onclick="iewc();">' + iews.msg4 + '</a>';
	...
	_li1ds.background = _li2ds.background = _li3ds.background = _li4ds.background = _li5ds.background = "transparent url('"
			+ imgPath + "background_browser.gif') no-repeat scroll left top";
	...
	_ico1ds.background = "transparent url('" + imgPath
			+ "browser_ie.gif') no-repeat scroll left top";
	_ico2ds.background = "transparent url('" + imgPath
			+ "browser_firefox.gif') no-repeat scroll left top";
	_ico3ds.background = "transparent url('" + imgPath
			+ "browser_safari.gif') no-repeat scroll left top";
	_ico4ds.background = "transparent url('" + imgPath
			+ "browser_opera.gif') no-repeat scroll left top";
	_ico5ds.background = "transparent url('" + imgPath
			+ "browser_chrome.gif') no-repeat scroll left top";

	_lit1.appendChild(document.createTextNode(iews.br1));
	_lit2.appendChild(document.createTextNode(iews.br2));
	_lit3.appendChild(document.createTextNode(iews.br3));
	_lit4.appendChild(document.createTextNode(iews.br4));
	_lit5.appendChild(document.createTextNode(iews.br5));
...
function iewc() {
	...
	if(iews.cookie != 'no') iewcc('iew_dontShowAgain', 1, iews.cookie);
}

function iewcc(name, value, days) {
	if (days) {
		var date = new Date();
